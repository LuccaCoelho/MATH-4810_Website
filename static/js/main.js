/* ════════════════════════════════════════════════════════════════════════════
   shared.js — Valuation Engine
   Single JS file for all pages. Each section is guarded by an element
   existence check so it runs safely on pages that don't need it.
   ════════════════════════════════════════════════════════════════════════════ */

/* ══════════════════════════════════════════════════════════════════
   PARCEL LOOKUP + AUTOFILL  (main.html, main_nonlinear.html)
   ══════════════════════════════════════════════════════════════════ */

// FIELD_MAP is defined inline in each form page because the mapping
// differs slightly between linear and nonlinear (different fields).
...
(function initParcelInput() {
  ...
  // Sanitise input: linear allows alphanumeric + dash; nonlinear digits only.
...
/* ══════════════════════════════════════════════════════════════════
   HISTORY PAGE — expandable feature rows
   ══════════════════════════════════════════════════════════════════ */
...
/* ══════════════════════════════════════════════════════════════════
   ...
   All chart code is wrapped in an IIFE that bails early if the
   required DOM elements / data aren't present.
   ══════════════════════════════════════════════════════════════════ */
(function initResultCharts() {
  // Data injected by Jinja lives on window.* — bail if not present
  if (typeof PREDICTED === 'undefined') return;

  /* ── SVG helpers (shared by all chart functions) ── */
  ...
  function plotResidHist(d) {
    ...
    // Normal curve overlay — approximate using rescaled Gaussian
  ...
  /* ── Waterfall chart (nonlinear only) ── */
  ...
  /* ── SHAP Stack Waterfall (nonlinear only) ── */
